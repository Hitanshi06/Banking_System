  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-black ">
        <div class="container-fluid d-flex">
            <img src="img/logo2.jpg" alt="" width="40" height="40" class="mx-2 d-inline-block align-text-top">
            <a class="navbar-brand" href="index.php">Star Banking</a>
    ...
    <div id="carouselExampleCaptions" class="carousel slide " data-bs-ride="carousel">
        ...
        <div class="carousel-item active">
            <img src="img/slide1.jpg" class="d-block w-100" alt="..." height="490px" >
            <div class="carousel-caption d-none d-md-block">
            </div>
          </div>
        <div class="carousel-item">
            <img src="img/slide2.jfif" class="d-block w-100" alt="..." height="490px" >
            <div class="carousel-caption d-none d-md-block">
            </div>
          </div>
        <div class="carousel-item">
            <img src="img/s3.jpg" class="d-block w-100" alt="..." height="490px">
            <div class="carousel-caption d-none d-md-block">
            </div>
          </div>
        <div class="carousel-item">
            <img src="img/slide4.jfif" class="d-block w-100" alt="..." height="490px">
            <div class="carousel-caption d-none d-md-block">
            </div>
          </div>
        <div class="carousel-item">
            <img src="img/slide5.jfif" class="d-block w-100" alt="..." height="490px">
            <div class="carousel-caption d-none d-md-block">
            </div>
          </div>
        </div>
...
<div class="services-section">
        <h1 class="section-title" id="card1">WHAT WE OFFER!!</h1>
        ...
        <div class="services-container">
            ...
            <div class="service-box">
                ...
                <div class="service-desc">
                A business loan is a kind of financing you can avail to meet the urgent needs of your growing business. Business loans allow you <br>to usher in funds for your enterprise to expand your existing business,take your operations online, buy new machinery, and more
                </div>
            </div>
            <div class="service-box">
                <div class="service-icon">
                ...
                <div class="service-desc">
                The gold loan, also referred as a loan against gold, is a secured <br>loan that a borrower takes from a lender in lieu of gold ornaments such as gold jewelry.You can repay it through monthly installment after which you get your gold articles back. 
                </div>
            </div>
        </div>
    </div>
...
<div class="container">
   <div class="card1">
       ...
       <p>We care about our customers, Our clients are always front of mind.
        ...
        <a href="customer.php"><i class="fa fa-user" aria-hidden="true">View all User</i></a>
       </div>
   </div> 
   <div class="card1">
       <div class="circle">
       ...
       <p>We provide record of all activities that occur in an account!</p>
        <a href="transfer_history.php"><i class="fa fa-history" aria-hidden="true">Transfer History</i></a>
       </div>
   </div> 
   <div class="card1">
       <div class="circle">
       ...
       <p>We leave you with no surprises, from reconciling your bank transactions daily through to providing cash forecasting.</p>       
        <a href="#"><i class="fas fa-exchange-alt">Bank Transfer</i></a>
       </div>
   </div> 
</div>
</section>
    ...
    <section id="contactus">
        <div class="container-fluid bg-light   mt-4 mb-0 ">
                    ...
                    <div class="col-md-6 order-md-first order-last mt-4 ">
                        <div class="container-lg px-lg-5 ">
                            <form class="contact_form" onsubmit="event.preventDefault(); contactUs();"
                                ...
                                <button type="submit" class="btn btn-secondary submit_button" l>Submit</button>
                            </form>
                        </div>
                    </div>
                    <div class=" col-md-6 order-md-last order-first mt-4 pb-4  ">
                        <iframe src="
    ...
    <footer class="containerr1 bg-light text-center text-white">
        ...
        <div class="center">
            <div class="text-center p-3" style="background-color: black; font-weight: 700;">
