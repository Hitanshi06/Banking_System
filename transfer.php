    ...
    if(isset($_POST['submit']))
    {
        ...
        else 
        {
                ...
                if($query)
                {
                        ...
                        echo '<script type="text/javascript">';
                        echo 'setTimeout(function () { swal("","Transfer Successful","success"),function(){
...
<head>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-black ">
        ...
        <div class="container">
            ...
            <br>
            <br>
            <h2 class="text-center "  style="font-family: emoji;margin-top: -35px;"><b>CUSTOMER DETAILS</b>
            </h2>
            <?php
                include 'config.php';
                $sid=$_GET['account_no'];
            ...
            ?>
                <form method="post" name="tcredit" class="tabletext"><br>
                    ...
                    <br><br><br>
                    <h2 class="text-center" style="font-family: emoji;margin-top: -38px;"><b>TRANSFER MONEY</b></h2>
